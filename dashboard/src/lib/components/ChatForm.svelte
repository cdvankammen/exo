  ...
  >
      ...
      >
        <div class="flex items-center gap-2 flex-1">
          ...
          <div class="relative flex-1 max-w-xs">
            <button
              type="button"
              onclick={() => { samplingOpen = false; onOpenModelPicker?.(); }}
    ...
    <div class="flex items-start gap-2 sm:gap-3 py-3 px-3 sm:px-4">
      ...
      <div class="relative">
        ...
        {#if samplingOpen}
          <div
            class="absolute right-0 bottom-full mb-2 w-64 p-3 rounded border border-exo-yellow/30 bg-exo-black/95 shadow-xl z-50 flex flex-col gap-2 pointer-events-none"
          >
            {#each [
              ...
              <label
                class="flex items-center justify-between gap-2 text-[11px] font-mono text-exo-light-gray pointer-events-auto"
              >
                <span>{label}</span>
                <input
                  type="number"
